...
def evaluate_financial_scenario(
    ...
    revenue_cap = _number_term(term_map, "maximum_usage_payment_cap")
    ...
    overage_revenue = billable_overage_units * overage_price
    ...
    capped_revenue = min(gross_revenue - recurring_discount - temporary_discount, revenue_cap) if revenue_cap else gross_revenue - recurring_discount - temporary_discount
    cap_adjustment = max(0, gross_revenue - recurring_discount - temporary_discount - capped_revenue)
    rebates = capped_revenue * (rebate_percent / 100)
    credits_penalties = capped_revenue * (service_credit_percent / 100)
    ...
    breakdown = [
        ...
        _line("Overage revenue", overage_revenue, currency, "overage_pricing", None, "expected_usage_units"),
